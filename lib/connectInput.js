...
var getValidationFunction = function getValidationFunction(validateProp) {
  ...
  if (!_validators3.default[correspondance[validateProp]]) throw new Error(validateProp + ' validator does not exist. Check makeValidable()');
  return _validators3.default[correspondance[validateProp]];
};
...
exports.default = function (Comp) {
  return (function (_Component) {
    ...
    function Validable(props) {
      ...
      var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Validable).call(this, props));
    ...
    _createClass(Validable, [{
      ...
      value: function componentWillMount() {
        ...
        if (this.props.validate && this.props.validate.length > 0) {
          ...
          var _validators = this.props.validate.map(function (prop) {
          ...
          if (this.props.validate.indexOf('required') === -1) {
            ...
            this.validator = _jsfp.utils.compose(chain(_validators), makeDownstreamValidatorAgreable);
          } else {

            // Chain all validators
            this.validator = chain(_validators);
          }
      ...
      value: function render() {
        ...
        var className = 'form-item ' + (mandatory ? 'mandatory' : '');
