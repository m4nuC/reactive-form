...
exports.default = function (Comp) {
  ...
  return function (_Component) {
    ...
    function Validable(props) {
      ...
      _this._errorMessages = opt && opt.errorMessages ? Object.assign({}, defaultErrorMessages, opt.errorMessages) : defaultErrorMessages;
      return _this;
    }

    _createClass(Validable, [{
      key: 'reachedMaxChars',
      value: function reachedMaxChars(value) {
      ...
      value: function componentWillMount() {
        ...
        if (this.props.validate && this.props.validate.length > 0) {
          ...
          validators = this.props.validate.map(function (prop) {
            var message = _this2._options.errorFormatter ? _this2._options.errorFormatter(_this2._errorMessages[prop]) : _this2._errorMessages[prop];
          ...
          if (this._options.defaultValidator && this._options.defaultValidator.validationFunction) {
            validators.push(makeValidator(this._options.defaultValidator.validationFunction, this._options.defaultValidator.errorMessage));
          }
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(Comp, _extends({ ref: 'wrappedInput'
            ...
            propagateValue: function propagateValue(value) {
              return _this3.propagateValue(value);
            },
